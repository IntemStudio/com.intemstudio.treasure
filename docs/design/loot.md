...
관련: [`combat.md`](combat.md) · [`equipment.md`](equipment.md) · [`village.md`](village.md) · [`hud.md`](hud.md) · [`game-log.md`](game-log.md) · [`save-load.md`](save-load.md) · [`map.md`](map.md) (`reward_type`) · [`shop.md`](shop.md) (`reward_mult`는 가격에도 금지).
